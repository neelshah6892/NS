...
def merge():
	df1 = pd.DataFrame(file1, sheet_name='Sheet1')
	df2 = pd.DataFrame(file2, sheet_name='Sheet1')
	#df1 = pd.read_excel(file1, sheet_name='Sheet1')
	#df2 = pd.read_excel(file2, sheet_name="Sheet1")
	print(df1-df2)
	print(df2-df1)
	#df3 = pd.merge(left=df1, right=df2, how='outer', left_index=True, right_index=True)
	#print(df.shape())
	#df.tail()

def reset():
	df1 = pd.read_excel(file2, skipfooter=1)
	size1 = data.size
	print(size1)
	#print(df1)
	#print(df.shape())
